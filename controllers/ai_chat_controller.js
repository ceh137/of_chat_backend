...
exports.changeMessageSlightly = async (req, res, next) => {
    try {
        ...
        if (response.data.choices[0].text.split(": ")[0]?.includes("You")) {
...
exports.addConversation = async (req, res, next) => {
    try {
        ...
        let of_sender_id = req.body.onlyFansSenderId
        console.log(req.body)

        conversation = await AiConversation.create({
            onlyFansId: of_id,
            onlyFansSenderId: of_sender_id,
            UserId: req.body.userId
        })

        res.status(201).json({
            id: conversation.id,
            onlyFansSenderId: conversation.onlyFansSenderId,
...
exports.getConversation = async (req, res, next) => {
    try {
        ...
        let of_sender_id = req.query.onlyFansSenderId;
